package com.infoyb.supplier.common.utils.upload;
...
//                    }
                    ...
                    if (booIsType) {
                        ...
                        //是否随机名称
                        if (isRandomName) {
                            origName = DateUtil.formatDate(new Date(), "yyyy-MM-dd") + UUID.randomUUID().toString() + origName.substring(origName.lastIndexOf("."));
                        }
                        //判断是否存在目录
