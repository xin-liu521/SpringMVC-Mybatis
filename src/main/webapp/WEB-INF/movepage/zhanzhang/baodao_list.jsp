    ...
    <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
        ...
        <div id="main-container">
            ...
            <div id="page-content">
                <!-- First Row -->
                <div class="row panel">
                    <h3 class="text-center" style="color: red;">待报到骑手信息</h3>
                    <div class="panel-group" id="accordion" style="margin: auto 5%;">
                        <p style="padding-left: 3%;"> 待报到人数 ：<span style="color: red;">${count}</span>人</p>
                                ...
                                <div class="panel table-bordered" style="padding-left: 5%;">
                                    ...
                                    <div id="collapse_${index}" class="panel-collapse collapse">
                                        <p data-toggle="collapse" data-parent="#accordion" href="#"  style="color: #2f96b4">
                                            <span class="col-xs-11"><strong>待报到时间：<fmt:formatDate value="${preworker.baodaodate}" pattern="yyyy-MM-dd"/></strong></span><br>
