    ...
    <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
        ...
        <div id="sidebar">
            ...
            <div id="sidebar-brand" class="themed-background">
                <a href="indexrs.jsp" class="sidebar-title">
            ...
            <div id="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-lg-3">
                        <a href="${pageContext.request.contextPath}/preworkerAction_moveRsPageQuery.action" class="widget">
                    ...
                    <div class="col-xs-6 col-lg-3">
                        <a href="${pageContext.request.contextPath}/daibaodaoAction_moveBdRsPageQuery.action" class="widget">
                            <div class="widget-content widget-content-mini text-right clearfix">
                    ...
                    <div class="col-xs-6 col-lg-3">
                        <a href="${pageContext.request.contextPath}/shiyongqiAction_moveRsSypageQuery.action" class="widget">
                            <div class="widget-content widget-content-mini text-right clearfix">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="widget" onclick="kaoqinClick();">
                            <div class="widget-content border-bottom">
                                <span class="pull-right text-muted">总人数${cqListCount}人</span>
                                人员考勤信息
                            </div>
                            <div class="widget-content widget-content-full-top-bottom border-bottom">
                                <div class="row">
                                    <div class="col-xs-6 border-right">
                                        <h3 class="widget-heading"><i class="gi gi-book_open text-dark push"></i> <small class="syfont" id="todayCount">出勤(0)人</small></h3>
                                    </div>
                                    <div class="col-xs-6 ">
                                        <h3 class="widget-heading"><i class="gi gi-user_add text-dark push"></i> <small class="syfont" id="qeqCount">未出勤(0)人</small></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-content widget-content-full-top-bottom border-bottom">
                                <div class="row">
                                    <div class="col-xs-6 border-right">
                                        <h3 class="widget-heading"><i class="gi gi-briefcase text-dark push"></i> <small class="syfont" id="cdCount">迟到(0)人</small></h3>
                                    </div>
                                    <div class="col-xs-6">
                                        <h3 class="widget-heading"><i class="gi gi-truck text-dark push"></i> <small class="syfont" id="qjCount">请假(0)人</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="widget" onclick="leaverClick();">
                            <div class="widget-content border-bottom">
                                <span class="pull-right text-muted">离职总人数${leaverCount}人</span>
                                人员离职信息
                            </div>
                            <div class="widget-content widget-content-full-top-bottom border-bottom">
                                <div class="row">
...
<script>
    ...
    function kaoqinClick(){
        window.location.href = '${pageContext.request.contextPath}/kaoqinAction_moveRsPageQuerykq.action';
    }

    //离职跳转页面
    function leaverClick() {
        window.location.href = '${pageContext.request.contextPath}/leavereqAction_moveRsplist.action';
    }
</script>