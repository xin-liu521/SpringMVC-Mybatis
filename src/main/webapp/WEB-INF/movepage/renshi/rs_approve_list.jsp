    ...
    <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
        ...
        <div id="main-container">
            ...
            <div id="page-content">
                <!-- First Row -->
                <div class="row panel">
                    <h3 class="text-center" style="color: red;">待审批骑手信息</h3>
                    <div class="panel-group" id="accordion" style="margin: auto 5%;">
                        <p style="padding-left: 3%;"> 待审批人数 ：<span style="color: red;">${count}</span>人</p>
                        <div class="panel-group" id="accordion">
                            ...
                            <c:forEach items="${preworkerList}" var="preworker" varStatus="status">
                                ...
                                <div class="panel table-bordered" style="padding-left: 5%;">
                                    <!-- 展开部分 -->
                                    <p data-toggle="collapse" data-parent="#accordion" href="#collapse0" style="padding: 10px;">
                                    ...
                                    <div id="collapse0" class="panel-collapse collapse">
                                        <p data-toggle="collapse" data-parent="#accordion" href="#"  style="color: #2f96b4">
                                            <span class="col-xs-11"><strong>离职原因：${preworker.reason}</strong></span><br>
                                                <%--<span class="col-xs-11"><strong>入职日期：${preworker} </strong></span><br>--%>
                                            <span class="col-xs-11"><strong>申请日期：<fmt:formatDate value="${preworker.reqdate}" pattern="yyyy-MM-dd"/> </strong></span><br>
                                            <span class="col-xs-11"><strong>站长审批时间：<fmt:formatDate value="${preworker.leavedate}" pattern="yyyy-MM-dd"/> </strong></span><br>
                                            <span class="col-xs-11"><strong>地区：${preworker.regionname} </strong></span><br>
                                            <span class="col-xs-11"><strong>站点：${preworker.stationname} </strong></span>
                                        </p>
                                    </div>
                                </div>
                            </c:forEach>
