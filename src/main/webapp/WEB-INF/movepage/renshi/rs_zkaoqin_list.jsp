            ...
            <div id="page-content">
                ...
                <div class="row panel panel-default">
                    ...
                    <ul id="myTab" class="nav nav-tabs"  style="margin: auto 8%;">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/kaoqinAction_moveRsYxkq.action" >夜宵班 </a>
                        </li>
                    </ul>
                    <div class="Jhds">
