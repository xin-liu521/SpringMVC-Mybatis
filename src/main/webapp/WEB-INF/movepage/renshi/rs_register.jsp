    ...
    <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
        ...
        <div id="sidebar">
            ...
            <div id="sidebar-brand" class="themed-background">
                <a href="/preworkerAction_pageRsQueryCount.action" class="sidebar-title">
        ...
        <div id="main-container">
            ...
            <div id="page-content">
                <!-- First Row -->
                <div class="row panel">
                    <h3 class="text-center" style="color: red;">预登记骑手信息</h3>
                    <div class="panel-group" style="margin: auto 5%;">
                        <p style="padding-left: 3%;"> 预登记人数 ：<span style="color: red;">${count}</span>人</p>
                                ...
                                <div class="panel table-bordered" style="padding-left: 5%;">
                                    ...
                                    <div id="collapse_${index}" class="panel-collapse collapse">
                                        <p data-toggle="collapse" data-parent="#accordion" href="#" style="color: #2f96b4">
                                            <span class="col-xs-10"><strong>预面试时间：<fmt:formatDate value="${preworker.predate}" pattern="yyyy-MM-dd"/></strong></span><br>
                                            <span class="col-xs-10"><strong>地区：${preworker.region.name}</strong></span></br>
                                            <span class="col-xs-10"><strong>站点：${preworker.station.name}</strong></span>
                                        </p>
                                    </div>
                                </div>
                            </c:forEach>
