            ...
            <div id="page-content">
                ...
                <div class="row panel panel-default">
                    ...
                    <ul id="myTab" class="nav nav-tabs"  style="margin: auto 8%;">
                        <li>
                            <a  href="${pageContext.request.contextPath}/kaoqinAction_moveRsPageQuerykq.action">早餐班</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/kaoqinAction_moveRsZckq.action" >正常班</a>
                        </li>
                        <li class="active">
                            <a href="#" >夜宵班 </a>
                        </li>
