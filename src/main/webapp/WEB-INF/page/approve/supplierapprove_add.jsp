            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        ...
                        <button type="button" class="btn green" onclick="saveApproveBase(0)">保存</button>
                        <button type="button" class="btn green" onclick="referApproveBase(1)">提交</button>
                    ...
                    <div class="col-xs-10"  style="position:absolute; left:17%;height:100%; overflow:auto">
                        <form id="baseForm" class="horizontal-form">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="companyFullName" id="companyFullName" class="form-control" value="${byApproveBase.companyFullName}"
                                                                       <c:if test="${byApproveBase.companyType == 0 && byApproveBase.status!= 0 }">readonly</c:if>   placeholder="">
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="areaName" id="areaName" class="form-control" value="${byApproveBase.areaName}"
                                                                       <c:if test="${byApproveBase.companyType == 0 && byApproveBase.status!= 0 }">readonly</c:if> placeholder="请输入关键字，例如：西安">
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="form-group" style="padding-top: 25px;">
                                                                ...
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="isUnity"  id="isUnity1" value="0" <c:if test="${byApproveBase.isUnity == null || byApproveBase.isUnity == 0}">checked</c:if>
                                                                           <c:if test="${byApproveBase.companyType == 0 && byApproveBase.status!= 0 }">disabled</c:if>/>是
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="isUnity"  id="isUnity2" value="1" <c:if test="${byApproveBase.isUnity == 1}">checked</c:if>
                                                                           <c:if test="${byApproveBase.companyType == 0 && byApproveBase.status!= 0 }">disabled</c:if>/>否
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="fund" id="fund" class="form-control" value="${byApproveBase.fund}"
                                                                       <c:if test="${byApproveBase.companyType == 0 && byApproveBase.status!= 0 }">readonly</c:if> placeholder="单位：万元">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="createRegTime" id="createRegTime" type="text"
                                                                       ...
                                                                       class="form-control datetimepicker" <c:if test="${byApproveBase.companyType == 0 && byApproveBase.status!= 0 }">disabled</c:if> placeholder="请选择日期">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="email" name="email" class="form-control" value="${byApproveBase.email}"
                                                                   <c:if test="${byApproveBase.companyType == 0 && byApproveBase.status!= 0 }">readonly</c:if> placeholder="该邮箱用于密码找回">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                ...
                                                <c:when test="${byProducts != null && byProducts.size() > 0}">
                                                    <c:forEach items="${byProducts}" var="product" varStatus="i" begin="0" end="${byProducts.size()}" step="1">
                                                        ...
                                                        <div class="row" >
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">供应商产品分类<span style="color:red">*</span></label>
                                                                    ...
                                                                    <%--<input type="text" name="productTypeNames_${prIndex}" id="productTypeNames_${prIndex}"  names="productTypeName"  value="${product.productTypeName}"  class="form-control" placeholder="请输入关键字，例如：工字钢">--%>
                                                                    <select class="form-control" id="productTypes_${prIndex}" name="productTypes_${prIndex}" names="productType">
                                                    ...
                                                    <div class="row" >
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <%--<input type="text" id="productTypeNames" name="productTypeName" names="productTypeName" class="form-control" placeholder="请输入关键字，例如：工字钢">--%>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="bankTypeNameOne_${bakIndex}" name="bankTypeNameOne_${bakIndex}" names="bankTypeName" class="form-control "
                                                                               value="${bank.bankTypeName}" placeholder="请输入关键字，例如：工商银行">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                       ...
                                                                       <%-- <select class="form-control depBank"  id="depositBankOne_${bakIndex}"  name="depositBankOne_${bakIndex}" names="depositBank" required onchange="depositBankCh(this);">
                                                                            <option value="">请选择</option>
                                                                            <c:forEach items="${bank.sysCodeList}" var="sysCode">
                                                                                <option value="${sysCode.codeId}" <c:if test="${sysCode.codeId == bank.depositBank}">selected</c:if>>${sysCode.codeName}</option>
                                                                            </c:forEach>
                                                                        </select>--%>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" id="bankTypeTwo" name="bankTypeTwo" class="form-control bankTY"/>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="control-label">联行号<span style="color:red">*</span></label>
                                                                    <%--<input type="text" name="associatedNumber" names="associatedNumber" class="form-control associated" placeholder="">--%>
                                                                <input type="text" id="associatedNumber" name="associatedNumber" readonly names="associatedNumber" class="form-control associated" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div id='modal_message' style="text-align: center"><h4>操作正在进行中.....</h4></div>
...
<script src="${pageContext.request.contextPath}/assets/jquery-ui-1.12.1/jquery-ui.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/approve/supplierapprove_add.js"></script>
<script>
...
//                '<input type="text" id="productTypeName_' + idx + '"  name="productTypeName_' + idx + '" names="productTypeName" class="form-control" placeholder="请输入关键字，例如：工字钢"/>' +
    ...
    function bankDiv () {
        ...
        $("#bankForm").find(".form-body").append(
                ...
                '<label><input name="isElectronAccount_'+bankIndex+'" names="isElectronAccounts"  type="radio" value="1" onclick="electChange(this);"  checked />否</label>'+
