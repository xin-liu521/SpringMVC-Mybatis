                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="companyFullName" id="companyFullName"
                                                               class="form-control"
                                                               value="${byApproveBase.companyFullName}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="companyFullEg" id="companyFullEg"
                                                               class="form-control"
                                                               value="${byApproveBase.companyFullEg}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="companyShortName" id="companyShortName"
                                                               class="form-control"
                                                               value="${byApproveBase.companyShortName}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="companyShortEg" id="companyShortEg"
                                                               class="form-control"
                                                               value="${byApproveBase.companyShortEg}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="area" id="area" class="form-control"
                                                               value="${byApproveBase.area}" placeholder="">
                                                        <input type="text" name="areaName" id="areaName"
                                                               class="form-control" value="${byApproveBase.areaName}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="legalPerson" id="legalPerson"
                                                               class="form-control" value="${byApproveBase.legalPerson}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="isUnity" id="isUnity1" value="0"
                                                                   <c:if test="${byApproveBase.isUnity == 0}">checked</c:if>
                                                                   disabled/>是
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="isUnity" id="isUnity2" value="1"
                                                                   <c:if test="${byApproveBase.isUnity == 1}">checked</c:if>
                                                                   disabled/>否
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row" id="div1">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="socialCreditCode" id="socialCreditCode"
                                                               class="form-control"
                                                               value="${byApproveBase.socialCreditCode}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="licenseNumber" id="licenseNumber"
                                                               class="form-control"
                                                               value="${byApproveBase.licenseNumber}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="organizationCodeNumber"
                                                               id="organizationCodeNumber" class="form-control"
                                                               value="${byApproveBase.organizationCodeNumber}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="taxNumber" id="taxNumber"
                                                               class="form-control" value="${byApproveBase.taxNumber}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="economicsType"
                                                                name="economicsType" disabled>
                                                            <option value="0"
                                                                    <c:if test="${byApproveBase.economicsType == 0}">selected</c:if>>
                                                                国有经济
                                                            </option>
                                                            <option value="1"
                                                                    <c:if test="${byApproveBase.economicsType == 1}">selected</c:if>>
                                                                集体经济
                                                            </option>
                                                            <option value="2"
                                                                    <c:if test="${byApproveBase.economicsType == 2}">selected</c:if>>
                                                                私营经济
                                                            </option>
                                                            <option value="3"
                                                                    <c:if test="${byApproveBase.economicsType == 3}">selected</c:if>>
                                                                个体经济
                                                            </option>
                                                            <option value="4"
                                                                    <c:if test="${byApproveBase.economicsType == 4}">selected</c:if>>
                                                                股份制
                                                            </option>
                                                            <option value="5"
                                                                    <c:if test="${byApproveBase.economicsType == 5}">selected</c:if>>
                                                                外商投资
                                                            </option>
                                                            <option value="6"
                                                                    <c:if test="${byApproveBase.economicsType == 6}">selected</c:if>>
                                                                港澳台投资
                                                            </option>
                                                            <option value="7"
                                                                    <c:if test="${byApproveBase.economicsType == 7}">selected</c:if>>
                                                                其它经济
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="createRegTime" id="createRegTime" type="text"
                                                               disabled
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="address" name="address"
                                                               class="form-control" value="${byApproveBase.address}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="contact" name="contact"
                                                               class="form-control" value="${byApproveBase.contact}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="contactPhone" name="contactPhone"
                                                               class="form-control"
                                                               value="${byApproveBase.contactPhone}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="postcode" name="postcode"
                                                               class="form-control" value="${byApproveBase.postcode}"
                                                               readonly placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="webAddress" name="webAddress"
                                                               class="form-control" value="${byApproveBase.webAddress}"
                                                               readonly placeholder=""></div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="productTypeName"
                                                                       class="form-control" placeholder="请输入关键字，例如：工字钢">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </c:otherwise>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <c:choose>
                                                <c:when test="${byBanks != null && byBanks.size() > 0}">
                                                    <c:forEach items="${byBanks}" var="bank" varStatus="i" begin="0"
                                                               end="${byBanks.size()}" step="1">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label"
                                                                            ...
                                                                            <input type="checkbox" value="0"
                                                                                   name="isElectronAccount" disabled
                                                                                   <c:if test="${bank.isElectronAccount == 0}">checked</c:if>
                                                                                   onchange="electChange(this);"/>是否电子承兑账号</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label><input
                                                                                name="accountPropertiesOne_${bakIndex}"
                                                                                names="accountProperties" type="radio"
                                                                                value="0"
                                                                ...
                                                                <div class="col-md-4 account" id="yhDiv_${bakIndex}">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="bankAccount"
                                                                               names="bankAccount"
                                                                               class="form-control inputaccoun" readonly
                                                                               <c:if test="${bank.isElectronAccount == 1}">value="${bank.bankAccount}"</c:if>
                                                                               placeholder=""/>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 electron" style="display: none"
                                                                     id="dzDiv_${bakIndex}">
                                                                    <div class="form-group">
                                                                        <label class="control-label">电子银行承兑账号</label>
                                                                        <input type="text" name="electronAccount"
                                                                               names="electronAccount"
                                                                               class="form-control elecinput" readonly
                                                                               <c:if test="${bank.isElectronAccount == 0}">value="${bank.bankAccount}"</c:if>
                                                                               placeholder=""/>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="hidden"
                                                                               id="bankTypeOne_${bakIndex}"
                                                                               name="bankTypeOne_${bakIndex}"
                                                                               names="bankType"
                                                                               class="form-control bankType"
                                                                               placeholder=""
                                                                               value="${bank.bankType}"
                                                                               onchange="bankTypes(this);">
                                                                        <input type="text"
                                                                               id="bankTypeNameOne_${bakIndex}"
                                                                               name="bankTypeName" names="bankTypeName"
                                                                               class="form-control "
                                                                               value="${bank.bankTypeName}" readonly
                                                                               placeholder="请输入关键字，例如：工商">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="bankAccountName"
                                                                               names="bankAccountName"
                                                                               value="${bank.bankAccountName}" readonly
                                                                               class="form-control" placeholder="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control depBank"
                                                                                name="depositBank" names="depositBank"
                                                                                disabled>
                                                                            <option value="${bank.depositBank}"
                                                                                    selected>${bank.depositBankName}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="associatedNumber"
                                                                               names="associatedNumber"
                                                                               value="${bank.associatedNumber}"
                                                                               class="form-control" readonly
                                                                               placeholder="">
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="font-weight: bold">
                                                        <input type="checkbox" name="isChemical" id="isChemical"
                                                               disabled
                                                               <c:if test="${byApproveBase.isChemical == 0}">checked</c:if>
                                                               value="0"/>是否危险化学品
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <c:if test="${byDocList!=null && byDocList.size() != 0}">
                                                            <c:choose>
                                                                <c:when test="${byDocList!=null && byDocList.size() != 0}">
                                                                    ...
                                                                    <%--<td colspan="5"> 附件${byDocList.size()}个 <button type="button" class="btn blue" onclick="batchDownloadFiles()">全部下载</button></td>--%>
                                                                    <%--</c:if>--%>
                                                                    <c:forEach items="${byDocList}" var="doc"
                                                                               varStatus="status">
                                                                        <p class="file-other-title" id="${doc.id}"
                                                                           style="text-align: left">
                                                                            <span>${doc.docName}</span>
                                                                                <%--<button type="button" class="user_up_button search-min-button">预览</button>--%>
                                                                            <a href="http://10.20.2.45:8080${doc.docUrl}">下载</a>
                                                                        </p>
                                                                        </p>
                                                                    </c:forEach>
                                                                </c:when>
