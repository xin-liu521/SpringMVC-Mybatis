        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="second">
                        <c:if test="${byApproveBase.supplierStatus == 2}">
                        ...
                        <c:if test="${byApproveBase.supplierStatus == 3}">
                            <div class="mt-element-step">
                                <div class="row step-no-background">
                                    ...
                                    <div class=" mt-step-col error">
                                        ...
                                        <a href="${pageContext.request.contextPath}/approveBase/supplierApproveBasePage">
                                            <h1>重新提交资料</h1>
                                        </a>
